...
/*
전개 구문 (spread syntax)
- ...표기법을 사용하여 값 말고도 배열안의 항목을 펼치는 방식으로 할당이 가능하다.
*/
...
배열 복사
- 배열은 객체이기 때문에 참조값을 갖고 있어서 이 값을 다른 배열에 할당하면 같은 참조값을 갖기 때문에 한 배열에서 값을 변경하면 다른 배열도 함께 변경이 된다.(얕은 복사라고 한다.)
