...
name = "신규섭"; // name 변수의 값을 신규섭으로 변경



// let name = "asdf";  같은 영역안에 추가 생성 불가
...
/*
식별자 규칙
- 글자, $(달러), _(밑줄)로 시작 할 수 있고 숫자로 시작할 수 없다.
...
네이밍 규칙
- 카멜 케이스(주로 사용)
  - 중간 단어의 첫 글자가 대문자이며 낙타의 혹처럼 보인다고 해서 카멜케이스 라고 불린다.
    ex) camelCaseNum

- 스네이크 케이스
  - 언더바가 들어있는 표현 방식이 뱀처럼 생겼다고 해서 스네이크 케이스라고 불린다.
    ex) snake_case_num
