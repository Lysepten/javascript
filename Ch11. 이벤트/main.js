...
- removeaddEventListener() : addEventListener로 등록했던 이벤트를 제거한다.
*/

// 인라인
// <button onclick="alert('hello ' + this.value)" value="world">인라인</button> (HTML에서 직접 등록)
...
이벤트 종류
- 마우스 이벤트
click : 마우스가 요소를 클릭했을때
mousedown : 마우스가 요소안에서 클릭이 눌릴 때 (마우스를 떼지 않아도 바로 발생)
...
let event4 = document.querySelector('img'); //defer 대신 async로 바꿔줘야 작동 
